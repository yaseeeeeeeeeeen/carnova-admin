...
import 'package:carnova_webapp/repositories/components/alert_box.dart';
import 'package:carnova_webapp/repositories/components/host_details_raw_widget.dart';
import 'package:carnova_webapp/repositories/components/small_button_widget.dart';
import 'package:carnova_webapp/repositories/components/sub_heading_widget.dart';
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          HostDetailsRowWidget(
                            title: 'Vehicle Model :',
                            details: vehicleModel.createdyear.toString(),
                            color: Colors.white,
                          ),
                          const SizedBox(height: 20),
                          HostDetailsRowWidget(
